     ...
     <button class="btn-two blue small" onclick="openCity('cafe')" name="cafe">까페</button>
           ...
           <div class="w3-center">                                             
            <form name="searchForm" method="post" action="/UserChat/datec/datec3.jsp">                     <!-- 검색하면 date3.jsp로 보냄 -->
               ...
               <input type="submit" class = "btn btn-primary small" value="찾기" >
            </form>
         </div>
<% 
   for(int i=0; i<datesearchlist.size(); i++){													/* datesearchlist 뿌려주는 코드 */
%>
<table class="w3-table-all w3-card-4border" >
...
<th width="300" rowspan="6" bgcolor="white" >
   ...
   <img  width = "300" height = "300" src = "/UserChat/ny/<%=datesearchlist.get(i).getDphoto() %>">
     ...
     <%  boolean mgrchk = mMgr.goodcheck(userID,datesearchlist.get(i).getDname()); %>
  <% if(mgrchk){ %>
  	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
